...
public:
    WidgetPtr build(BuildContext&) override {
        ...
        // ── Card 2: Frosted Glass BackdropFilter Showcase ──────────────
        ...
        // 3 Frosted Glass Containers floating over the colorful background
        auto makeGlassCard = [](std::shared_ptr<ImageFilter> filter, Color bg_color, Color border_color, Color text_color, const std::string& title, const std::string& sub, float w = 240.0f) {
            return clipRRect({
        ...
        // ── Eye-Catching Frosted Glass Buttons ─────────────────────────
        ...
        auto main_col = column({
            ...
            .gap = StyleValue::point(18.0f),
            .width = StyleValue::percent(100.0f),
            .children = { header, clip_card, effects_card, filter_card },
        });
