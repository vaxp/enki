# Mixed Syntax Widgets Report
This document contains a list of all widget demos that currently mix the legacy method-chaining syntax (e.g. `->color()`) and the new C++20 Designated Initializers syntax (e.g. `{ .color = 0xFFFFFFFF }`).
...
- [ ] `notification_demo` ([widgets_demo/notification_demo/main.cpp](file:///home/x/Work/enki/widgets_demo/notification_demo/main.cpp))
